...
#------------end of BcIcDataManufact class ------------------------------       
        
    
    

 
 #Stand alone functions to deal with data. Include functions to load and save data to specific file formats like csv.
 #----------------------------------------------------------------------------
